(function registerSlotV2Rules(global) {
  ...
  global.ToshiyaSlotV2Rules = {
    ...
    reel: {
      ...
      decorativeSymbols: ["face", "dogeza"],
      normalForbiddenLineSymbols: ["logo", "seven"],
      symbolStrips: [
        ["face", "replay", "watermelon", "seven", "logo", "bell", "bar", "cherry", "face", "replay", "watermelon", "seven", "logo", "bell", "bar", "cherry"],
        ["replay", "seven", "watermelon", "bell", "cherry", "logo", "face", "dogeza", "replay", "seven", "watermelon", "bell", "cherry", "logo", "face", "dogeza"],
      ...
      stopPatterns: {
        ...
        watermelon: [[1, 1, 4], [9, 9, 12]],
        weakCherry: [[7, 3, 6], [5, 11, 6], [15, 3, 14], [13, 11, 14]],
        chance: [[0, 5, 9], [4, 11, 2], [8, 1, 13]],
        strongCherry: [[6, 3, 6], [14, 11, 14]],
        normal7: [[2, 0, 3], [10, 8, 11]],
